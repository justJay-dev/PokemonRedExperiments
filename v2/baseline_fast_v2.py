    ...
    def _init():
        env = StreamWrapper(
            ...
            stream_metadata={  # All of this is part is optional
                "user": "pnJay",  # choose your own username
                "env_id": rank,  # environment identifier
                # "color": "#4CBB17",  # choose your color :)
                "color": "#782be3",  # choose your color :)
                "extra": "omegalul-0",  # any extra text you put here will be displayed
            },
        )
